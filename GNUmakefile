...
# Exclude ESS crates, Kuhnke slaves, and Beckhoff KL configurations.
SCRIPTS+=$(filter-out ./hardware/ESS_crates/% ./hardware/Kuhnke_slaves/% ./hardware/Beckhoff_KL/%,$(wildcard ./hardware/*/*.cmd))
