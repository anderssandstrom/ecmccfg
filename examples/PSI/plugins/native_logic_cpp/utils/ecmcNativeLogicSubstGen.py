...
def type_to_ftvl(value_type: int) -> str:
    if value_type == ECMC_NATIVE_TYPE_BOOL:
        return "UCHAR"
    if value_type in (ECMC_NATIVE_TYPE_S8, ECMC_NATIVE_TYPE_U8):
        return "CHAR"
    if value_type in (ECMC_NATIVE_TYPE_S16, ECMC_NATIVE_TYPE_U16, ECMC_NATIVE_TYPE_S32, ECMC_NATIVE_TYPE_U32):
        return "LONG"
    return "DOUBLE"
