...
dbLoadTemplate("${ecmccfg_DIR}ecmcFSoEMasterConnection.substitutions","P=${ECMC_PREFIX},ECMC_P=${ECMC_P},ECMC_G=${ECMC_G=},PORT=${ECMC_ASYN_PORT},ADDR=0,TIMEOUT=1,MASTER_ID=${ECMC_EC_MASTER_ID=0},SLAVE_POS=${SFTY_MASTER_SID},HWTYPE=FSoEMaster,T_SMP_MS=${ECMC_SAMPLE_RATE_MS},TSE=${ECMC_TSE},CH_ID=${SFTY_MASTER_CONN}")
