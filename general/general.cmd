...
#- Add realtime logger records
ecmcFileExist("ecmcRtLog.db",1,1)
dbLoadRecords("ecmcRtLog.db","P=${ECMC_PREFIX},PORT=${ECMC_RTLOG_PORT=ecmcRTLog},ADDR=0")

#- Add MCU sumamry records
ecmcFileExist("ecmcMcuInfoLast.db",1,1)
dbLoadRecords("ecmcMcuInfoLast.db","P=${ECMC_PREFIX},AXIS_COUNT=${ECMC_AXIS_COUNT=0},PLC_COUNT=${ECMC_PLC_COUNT=0},PLUGIN_COUNT=${ECMC_PLUGIN_COUNT=0},DS_COUNT=${ECMC_DS_COUNT=0},MOTION_SEQ_COUNT=${ECMC_MOTION_SEQ_COUNT=0},ECDOMAIN_COUNT=${ECMC_ECDOMAIN_COUNT=1},ECSLAVE_COUNT=${ECMC_ECSLAVE_COUNT=0}")
