...
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},1,2,0x1600,0x7000,0x01,U16,Us_Ctrl)"
#- Us_Ctrl: B0=Reset, B1=gap, B2=Enable, B3=Control via process data, B4..B15=gap

#- SM2, RxPDO 0x1610: Up output control.
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},1,2,0x1610,0x7010,0x01,U16,Up_Ctrl)"
#- Up_Ctrl: B0=Reset, B1=gap, B2=Enable, B3=Control via process data, B4..B15=gap

#- SM3, TxPDO 0x1a00: Us output status.
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a00,0x6000,0x01,U32,Us_Stat)"
...
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a10,0x6010,0x01,U32,Up_Stat)"
