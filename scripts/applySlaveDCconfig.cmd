...
#-d   \param SYNC_1_SHIFT (optional) Sync 1 shift time [ns]. Defaults to 0ns
...
ecmcConfigOrDie "Cfg.EcSlaveConfigDC(${ECMC_EC_SLAVE_NUM},${ASSIGN_ACTIVATE=${ECMC_EC_ASSIGN_ACTIVATE}},${SYNC_0_CYCLE=${ECMC_TEMP_PERIOD_NANO_SECS}},${SYNC_0_SHIFT=0},${SYNC_1_CYCLE=0},${SYNC_1_SHIFT=0})"
