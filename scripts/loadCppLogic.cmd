#==============================================================================
# loadCppLogic.cmd
#- Arguments: [FILE], [DIR], [LOGIC_ID], [ASYN_PORT], [SAMPLE_RATE_MS], [UPDATE_RATE_MS], [MACROS], [APP_PANEL], [LOAD_DEFAULT_PVS], [EPICS_SUBST], [DB_PREFIX], [DB_MACROS], [REPORT]
...
#else
  ${CPP_LOGIC_APP_SKIP_FALSE}ecmcFileExist("${EPICS_SUBST=''}",1,1)
  ${CPP_LOGIC_APP_SKIP_FALSE}ecmcIf("'${DB_MACROS=EMPTY}'='EMPTY'",CPP_LOGIC_APP_DB_EMPTY_TRUE,CPP_LOGIC_APP_DB_EMPTY_FALSE)
  ${CPP_LOGIC_APP_SKIP_FALSE}${CPP_LOGIC_APP_DB_EMPTY_TRUE=}dbLoadTemplate("${EPICS_SUBST=''}", "${ECMC_CPP_LOGIC_DB_MACROS_BASE}")
  #else
  ${CPP_LOGIC_APP_SKIP_FALSE}${CPP_LOGIC_APP_DB_EMPTY_FALSE=}dbLoadTemplate("${EPICS_SUBST=''}", "${ECMC_CPP_LOGIC_DB_MACROS_BASE},${DB_MACROS=''}")
  ${CPP_LOGIC_APP_SKIP_FALSE}ecmcEndIf(CPP_LOGIC_APP_DB_EMPTY_TRUE,CPP_LOGIC_APP_DB_EMPTY_FALSE)
